...
const SmaBiayaModal = ({ openModal, setOpenModal }) => {
  // Biaya data for SMA ONSITE
  const biayaData = [
    { no: '1', biaya: 'formulir Pendaftaran', amount: '100.000', ket: '1 kali diawal' },
    { no: '2', biaya: 'Biaya pendidikan Include Makan Siang', amount: '1.100.000', ket: 'Bulanan' },
    { no: '3', biaya: 'Dana Kegiatan', amount: '4.500.000', ket: 'Tahunan' },
    { no: '4', biaya: 'Dana Gedung', amount: '4.000.000', ket: '1 kali di awal' },
    { no: '5', biaya: 'Starter Kit', amount: '2.500.000', ket: '1 kali di awal' },
    { no: '', biaya: '', amount: '12.200.000', ket: 'Total' },
    { no: '', biaya: '', amount: '10.200.000', ket: 'untuk 10 orang pertama' }
  ];

  return (
    <Modal show={openModal} onClose={() => setOpenModal(false)}>
      <Modal.Header>BIAYA SMA ONSITE</Modal.Header>
      <Modal.Body>
        <div className="space-y-6">
          ...
          <Table>
            <Table.Head>
              ...
              <Table.HeadCell>SMA ONSITE</Table.HeadCell>
